        ...
        {productItemDto.currentVisibleStock > 0 && (
          <ProductQuantityButton
            onAddToCart={(quantity) =>
              handleAddToCart(supply.searchMapId, quantity)
            }
            maxStock={productItemDto.currentVisibleStock}
            disabled={productItemDto.currentVisibleStock < 1}
            layout="grid"
          />
        )}
      </div>
